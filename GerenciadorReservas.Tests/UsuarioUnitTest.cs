...
namespace GerenciadorReservas.Tests
{
    public class UsuarioUnitTest
    {
        ...
        {
            Action action = () => new Usuario(1, "Wellington Santos", "wellington.bezerra.santos@outlook.com");
            action.Should()
        ...
        {
            Action action = () => new Usuario(1, null, "wellington.bezerra.santos@outlook.com");
            action.Should()
        ...
        {
            Action action = () => new Usuario(1, "", "wellington.bezerra.santos@outlook.com");
            action.Should()
                .Throw<DomainExceptionValidation>()
                .WithMessage($"Nome inválido. O Nome é obrigatório.");
        }
        ...
        {
            Action action = () => new Usuario(1, "Well", "wellington.bezerra.santos@outlook.com");
            action.Should()
                .Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Usuario(1, "Wellington Santos", null);
            action.Should()
                .Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Usuario(1, "Wellington Santos", "");
            action.Should()
                .Throw<DomainExceptionValidation>()
                .WithMessage($"O e-mail é obrigatório.");
        }
        ...
        {
            Action action = () => new Usuario(1, "Wellington Santos", "well.gmail.com");
            action.Should()
                .Throw<DomainExceptionValidation>()
